...
//    @Pattern(regexp = "\\d+", message = "Employee age must be a number")
//    @Min(value = 18, message = "Employee age must be greater than 18")
//    @Max(value = 100, message = "Employee age must be less than 100")
//    private String emp_age;
//
//    @NotBlank(message = "Employee gender cannot be blank")
//    private String emp_gender;
//
//    @NotBlank(message = "Employee birth year cannot be blank")
//    @Size(min = 4, max = 4, message = "Employee birth year must be a 4-digit number")
//    private String emp_birth_year;
//
//    @NotBlank(message = "Employee marital status cannot be blank")
//    private String emp_marital_status;
//
...
//    
	...
	public EmployeeDetailsRequest(String emp_id, String emp_name, String emp_age, String emp_gender,
			String emp_birth_year, String emp_marital_status, String emp_department, String emp_designation,
			String emp_address) {
		super();
		this.emp_id = emp_id;
		this.emp_name = emp_name;
